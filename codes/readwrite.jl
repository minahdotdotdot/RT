...
@inline function newtxt!(zAmp::Vector{T}; name::String="zAmp") where T<:Float64
    writedlm("../txtfiles/"*name*".txt", transpose(zAmp))
end

@inline function addtxt!(zAmp::Vector{T}; name::String="zAmp") where T<:Float64
...
@inline function newtxt!(zAmp::Vector{T}; name::String="zAmp") where T<:AbstractFloat
    writedlm("../txtfiles/"*name*".txt", zAmp)
end
...
@inline function newtxt!(zAmp::Vector{T}; name::String="zAmp") where T<:Complex{Float64}
    writedlm("../txtfiles/"*name*"_Re.txt", transpose(real.(zAmp)))
    writedlm("../txtfiles/"*name*"_Im.txt", transpose(imag.(zAmp)))
end

@inline function addtxt!(zAmp::Vector{T}; name::String="zAmp") where T<:Complex{Float64}
...
function plotcomplex!(z::Vector{Complex{T}}) where T <: AbstractFloat
